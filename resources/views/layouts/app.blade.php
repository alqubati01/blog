...
<head>
    ...
    <meta name="description" content="A minimal, functional theme for running a paid-membership publication on Ghost." />
    ...
    <script type="application/ld+json">
        {
            ...
            "publisher": {
                "@type": "Organization",
                "name": "Basho",
                "url": "https://basho.fueko.net/",
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://basho.fueko.net/content/images/2022/01/basho.svg"
                }
            },
            "url": "https://basho.fueko.net/",
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://basho.fueko.net/"
            },
    ...
    <link rel="alternate" type="application/rss+xml" title="Basho" href="rss/index.html" />
    <script defer src="{{ asset('assets/js/portal.min.js') }}" data-ghost="https://basho.fueko.net/" data-key="3d825fc0e10091ccd9cd5c1f35" data-api="https://basho.fueko.net/ghost/api/content/" crossorigin="anonymous"></script><style id="gh-members-styles">.gh-post-upgrade-cta-content,
        .gh-post-upgrade-cta {
            display: flex;
    ...
    <div class="global-content">
        <header class="header-section">
            <div class="header-wrap global-padding">
                <div class="header-logo"><a href="index.html" class="is-logo"><img src="{{ asset('img/brand/basho.svg') }}" alt="Basho home"></a>
                </div>
...
{{--                            <li><a href="{{ route('showPosts') }}">Videos</a></li>--}}
{{--                            <li><a href="{{ route('showPodcasts') }}">Podcasts</a></li>--}}
                            <li><a href="{{ route('showTags') }}">Tags</a></li>
                            ...
                            <li class="signup"><a href="signup/index.html" class="global-button">Join</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="footer-container">
                    <div class="footer-content">
                        <div class="footer-logo">
                            <a href="index.html" class="is-logo"><img src="content/images/2022/01/basho.svg" alt="Basho home"></a>
                        </div>
                    ...
                    <div class="footer-nav">
                        ...
                        <div class="footer-nav-column">
                            ...
                            <ul>
                                <li><a href="demo-account-member/index.html">Account</a></li>
                    ...
                    <div class="footer-copyright">
                        &copy; <a href="index.html">Basho</a> 2023.
...
<script src="{{ asset('assets/js/globalbe.js') }}"></script>
<script src="{{ asset('assets/js/indexbe.js') }}"></script>
<script>
...
<script>
    const options = {
        api:'https://basho.fueko.net/ghost/api/content/posts/?key='+"64389e3d3495ebf52ab65908d2"+'&limit=all&fields=url,title,feature_image,published_at,custom_excerpt,visibility,html',
        threshold: 0.1,
        ignoreLocation: true,
...
<!-- Mirrored from basho.fueko.net/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2023 13:28:16 GMT -->
</html>
