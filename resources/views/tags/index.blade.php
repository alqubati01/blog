                ...
                @foreach($tags as $tag)
                    <div class="item is-loop">
                        <div class="item-image is-landscape global-image global-image-orientation global-radius">
                            <a href="{{ route('showTagPosts', ['title' => $tag->name, 'id' => $tag->id]) }}" class="global-link" aria-label="Idea"></a>
                            <img
                        ...
                        <div class="item-content">
                            <h2 class="item-title"><a href="{{ route('showTagPosts', ['title' => $tag->name, 'id' => $tag->id]) }}">{{ $tag->name }}</a></h2>
                            <small>{{ $tag->posts_count }} posts</small>
